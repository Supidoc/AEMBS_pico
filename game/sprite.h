...
/*!
 * \brief Decides if there is a moving sprite in the list or not
 * \param sprite Pointer to a sprite list
 * \return true if there is a moving sprite in the list, false otherwise
 */
bool Sprite_HasMovingSpriteInList(Sprite_t *list);

/*!
 * \brief Decides if there is an animated sprite in the list or not
 * \param sprite Pointer to a sprite list
 * \return true if there is a animated sprite in the list, false otherwise
 */
bool Sprite_HasAnimatedSpriteInList(Sprite_t *list);
