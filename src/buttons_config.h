...
#define BUTTONS_ENABLE_CLOCK()                                                                     \
    CLOCK_EnableClock(kCLOCK_PortA);                                                               \
    CLOCK_EnableClock(kCLOCK_PortB) /* enable clocking */
...
#define BUTTONS_ENABLE_CLOCK()                                                                     \
    GPIO_PortInit(GPIO, 0) /* ungate the clocks for GPIO0: used for user button */
#elif McuLib_CONFIG_CPU_IS_RPxxxx
#define BUTTONS_PINS_NAVUP_PIN 14u
#define BUTTONS_PINS_NAVDOWN_PIN 15u
#define BUTTONS_PINS_NAVLEFT_PIN 12u
#define BUTTONS_PINS_NAVRIGHT_PIN 13u
